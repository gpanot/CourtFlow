...
--
-- Name: class_pass_tiers; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.class_pass_tiers (
    id text NOT NULL,
    venue_id text NOT NULL,
    name text NOT NULL,
...
CREATE TABLE public.player_sticker_results (
    ...
    model character varying(50) DEFAULT 'gpt-image-1'::character varying NOT NULL,
    size character varying(20) DEFAULT '1024x1024'::character varying NOT NULL,
...
--
-- Name: class_pass_tiers class_pass_tiers_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.class_pass_tiers
    ADD CONSTRAINT class_pass_tiers_pkey PRIMARY KEY (id);
...
CREATE INDEX class_instances_tier_id_idx ON public.class_instances USING btree (tier_id);
...
CREATE INDEX class_pass_tiers_linked_coach_id_idx ON public.class_pass_tiers USING btree (linked_coach_id);
...
CREATE INDEX class_pass_tiers_venue_id_is_active_idx ON public.class_pass_tiers USING btree (venue_id, is_active);
...
CREATE INDEX class_passes_tier_id_idx ON public.class_passes USING btree (tier_id);
...
--
-- Name: sticker_payment_logs_sepay_id_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX sticker_payment_logs_sepay_id_key ON public.sticker_payment_logs USING btree (sepay_id);
...
ALTER TABLE ONLY public.class_instances
    ADD CONSTRAINT class_instances_tier_id_fkey FOREIGN KEY (tier_id) REFERENCES public.class_pass_tiers(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
--
-- Name: class_pass_tiers class_pass_tiers_linked_coach_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: class_pass_tiers class_pass_tiers_venue_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
ALTER TABLE ONLY public.class_passes
    ADD CONSTRAINT class_passes_tier_id_fkey FOREIGN KEY (tier_id) REFERENCES public.class_pass_tiers(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
-- migrate:down
-- intentionally empty, baseline is not reversible
