...
CMD ["sh", "-c", "mkdir -p /app/uploads/players /app/uploads/players/avatars /app/uploads/coaches/photos /app/uploads/proofs /app/uploads/manual-invoices /app/uploads/payment-proofs /app/uploads/signup-duplicates && psql $DATABASE_URL -c \"CREATE TABLE IF NOT EXISTS schema_migrations (version varchar(255) PRIMARY KEY NOT NULL);\" && psql $DATABASE_URL -c \"INSERT INTO schema_migrations (version) VALUES ('20260704000001_baseline') ON CONFLICT DO NOTHING;\" && psql $DATABASE_URL -c \"INSERT INTO schema_migrations (version) VALUES ('20260704000002_rename_class_pass_to_program_pass') ON CONFLICT DO NOTHING;\" && psql $DATABASE_URL -c \"DROP TABLE IF EXISTS _prisma_migrations;\" && dbmate migrate && node server.js"]
