...
CMD ["sh", "-c", "npx prisma migrate resolve --applied 20260309044022_init 2>/dev/null || true && npx prisma migrate deploy && mkdir -p /app/uploads/players /app/uploads/players/avatars /app/uploads/coaches/photos /app/uploads/proofs /app/uploads/manual-invoices /app/uploads/payment-proofs && node server.js"]
