  ...
  try {
    ...
    return json(
      coaches.map((c) => ({
        ...
        coachDupr: c.coachDupr,
        coachGender: c.coachGender,
        coachLanguages: c.coachLanguages,
        coachSpecialties: c.coachSpecialties,
        coachFocusLevels: c.coachFocusLevels,
        coachYearsExperience: c.coachYearsExperience,
        coachGroupSizes: c.coachGroupSizes,
