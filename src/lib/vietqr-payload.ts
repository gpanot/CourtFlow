 ...
 *
 * Generates the raw EMVCo QR string that banking apps scan directly,
 * bypassing the VietQR CDN image fetch. Used by both the PWA and (via
 * a mirrored copy) the React Native app so QR codes appear instantly
